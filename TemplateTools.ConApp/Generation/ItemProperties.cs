...
namespace TemplateTools.Logic.Generation
{
    ...
    internal partial class ItemProperties(string solutionName, string projectExtension)
    {
        ...
        /// </value>
        public static string[] TemplateProjectIdentifiers => CommonStaticLiterals.TemplateProjectExtensions.Select(e => e[1..]).ToArray();
        ...
        /// <summary>
        /// Creates the service model subtype based on the specified type.
        /// </summary>
        /// <param name="type">The type used to create the service model type.</param>
        ...
        public string CreateServiceModelSubType(Type type)
        {
            ...
            return $"{string.Join('.', namespaceItems)}.{CreateModelName(type)}";
        }
        /// <summary>
        ...
        /// <summary>
        /// Retrieves the sub namespace of the specified type.
        /// </summary>
        /// <param name="type">The type to retrieve the sub namespace for.</param>
        /// <returns>The sub namespace of the specified type.</returns>
        public string GetSubNameSpace(Type type)
        {
            return GetSubNameSpace(type.FullName!);
        }
        /// <summary>
        /// Returns the sub-namespace of a given type's full name by excluding certain folders or identifiers.
        /// </summary>
        /// <param name="typeFullName">The full name of the type.</param>
        /// <returns>A string representing the sub-namespace of the type's full name.</returns>
        public string GetSubNameSpace(string typeFullName)
        {
            var ignore = false;
            var result = new List<string>();
            var typeItems = typeFullName.Split('.');
        ...
        /// <summary>
        /// Retrieves the sub-namespace of the module for the given type.
        /// </summary>
        /// <param name="type">The type to get the sub-namespace for.</param>
        /// <returns>The sub-namespace of the module.</returns>
        public string GetModuleSubNameSpace(Type type)
        {
            return GetModuleSubNameSpace(type.FullName!);
        }
        ///<summary>
        /// Gets the sub-namespace of a module.
        ///</summary>
        ///<param name="typeFullName">The full name of the type.</param>
        ///<returns>The sub-namespace of the module.</returns>
        public string GetModuleSubNameSpace(string typeFullName)
        {
            var ignore = false;
            var result = new List<string>();
            var typeItems = typeFullName.Split('.');
        ...
        public string CreateAccessContractSubType(Type type)
        {
            ...
            return string.Join(".", namespaceItems.Union([CreateAccessContractName(type)]));
        }
        /// <summary>
        ...
        public string CreateServiceContractSubType(Type type)
        {
            ...
            return string.Join(".", namespaceItems.Union([CreateServiceContractName(type)]));
        }
        /// <summary>
        ...
        /// <summary>
        /// Creates the service contract type based on the given Type object.
        /// </summary>
        /// <param name="type">The Type object representing the service.</param>
        /// <returns>The fully qualified name of the service type.</returns>
        public string CreateServiceContractType(Type type)
        {
            return $"{CreateServiceContractNamespace(type)}.{CreateServiceContractName(type)}";
        }
        /// <summary>
        ...
        /// <param name="type">The type to create the service namespace for.</param>
        /// <returns>The created service namespace.</returns>
        public string CreateServiceContractNamespace(Type type)
        {
            return $"{ProjectNamespace}.{StaticLiterals.ContractsFolder}.{GetSubNameSpace(type)}";
        }
        /// <summary>
        ...
        /// <summary>
        /// Creates a page subpath from a given Type, fileName, and fileExtension.
        /// </summary>
        /// <param name="type">The Type used to create the subpath.</param>
        /// <param name="fileName">The name of the file.</param>
        /// <param name="fileExtension">The extension of the file.</param>
        /// <returns>The page subpath combing the PagesFolder, plural form of the Type's name, fileName, and fileExtension.</returns>
        public string CreatePageSubPathFromType(Type type, string fileName, string fileExtension)
        {
            var fileItems = new List<string>
            {
                StaticLiterals.PagesFolder
            };
            fileItems.AddRange(GetSubType(type).Split("."));
            fileItems[^1] = $"{fileName}{fileExtension}";
            
            return Path.Combine([.. fileItems]);
        }
        /// <summary>
        /// Creates a component subpath from a given Type, fileName, and fileExtension.
        /// </summary>
        /// <param name="type">The Type used to create the subpath.</param>
        /// <param name="fileName">The name of the file.</param>
        /// <param name="fileExtension">The extension of the file.</param>
        /// <returns>The page subpath combing the PagesFolder, plural form of the Type's name, fileName, and fileExtension.</returns>
        public string CreateComponentSubPathFromType(Type type, string fileName, string fileExtension)
        {
            var fileItems = new List<string>
            {
                StaticLiterals.SharedFolder
            };
            fileItems.AddRange(GetSubType(type).Split("."));
            fileItems[^1] = $"{fileName}{fileExtension}";
