 ...
 */
@Directive()
export abstract class GenericBaseListComponent<T extends IModel> implements OnInit, OnDestroy {
  ...
  public ngOnInit(): void {
    ...
    // Debounce search input to avoid an HTTP request on every keystroke
    this.searchSubject$
